...
const BiddingCalculator: React.FC = () => {
  ...
  const generateAgreementDocument = (
    bidder: BidderInfo,
    specs: ServiceSpecs
  ) => {
    // If selectedSpecs is not present, fallback to services list
    const specsDetails = (
      Array.isArray((specs as any).selectedSpecs)
        ? (specs as any).selectedSpecs
        : []
    )
      .map(
        (spec: any) =>
            ...
            <div className='grid md:grid-cols-3 gap-4 text-sm'>
              <div className='bg-slate-800/50 p-3 rounded-lg'>
                ...
                <p className='text-slate-300'>
                  Sees only: 10% commission amount and customer daily rate
                </p>
              </div>
              <div className='bg-slate-800/50 p-3 rounded-lg'>
                ...
                <p className='text-slate-300'>
                  Sees only: Service estimate, agreement, and daily rate
                </p>
              </div>
              <div className='bg-slate-800/50 p-3 rounded-lg'>
                ...
                <p className='text-slate-300'>
                  Sees: Full breakdown, expenses, ROI, profit margins
                </p>
              </div>
            </div>
          </CardContent>
