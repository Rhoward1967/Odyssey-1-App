...
- **EradiSkin™**: "SYNERGISTIC CO-THERAPY FOR ATOPIC DERMATITIS" (PPA Package Assembly Complete)
  - Financial Strategy: Dual Royalty Structure (5-8% on Cosmeceutical; 0.5-1.5% on Prescription Drug)
  - Milestone Payments: $500K - $1M upon FDA Approval
- **Ezekiel's Wheel (Autonomous VTOL)**: Tri-Foil Autonomous ISR Platform with Net-Positive Regenerative Cycle (Package Complete)
- **Project Sky Sovereign**: "QUANTUM AIRSPACE MANAGEMENT SYSTEM" utilizing Dream Theory Coding (DTC) and Constitutional Hardware Governance

**PAGE 7 of 21**

#### 3. Copyright Registrations (Literary Works)
**Registration Case # 1-15033889051** (Filed 11/06/2025 via eCO system)
Corporate Knowledge Base: "Sovereign Self Reclaiming Divine Intent" series
1. Book 1: "The Program: The Origin and Architecture of Disconnection"
2. Book 2: "The Echo: Deconstructing the Program's Legacy"
3. Book 3: "The Sovereign Covenant: Architecting a Divinely Aligned Future"
4. Book 4: "The Sovereign's True Collateral: The Bond of the People"
5. Book 5: "The Alien Program: Deconstructing the Frequencies of History, Identity, and Language"
6. Book 6: "The Sovereign's Armory: An Exposé and Guide to Reclaiming Divine Intent"
7. Book 7: "The Unveiling: How Crypto, Corruption, and AI Proved the Program"

**Purpose**: Proprietary foundation of ODYSSEY-1 knowledge base and ethical frameworks ("The Book")

#### 4. Software Copyrights (AGPL-3.0)
- **ODYSSEY-1 Software Platform**
  - All source code, documentation, and related materials
  - Git repository: c:\Users\gener\Odyssey-1-App
  - Development period: January 2025 - October 2025
  - Total investment: $14,000 personal funds
  - Production deployment: December 2025

- **R.O.M.A.N. AI System (v2.0)**
  ...
  - SovereignFrequencyLogger: Copyrighted method signatures (everyday, thanksForGivingBackMyLove)

- **THE HIVE Multi-Agent System**
  - GenesisEngine (DNA): Immutable battle-tested algorithms
  - HiveOrchestrator: Agent management and self-healing
  - All future iterations and improvements
...
- "EradiSkin™"
- "Ezekiel's Wheel"
- "Project Sky Sovereign"
- "QARE" (Quantum AI Reality Engine)

**PAGE 8 of 21**

### C. Business Entities and Assets
...
- **Corporate Documentation**:
  - Member Operating and Services Agreement (MOSA) - notarized and executed
  - Financial Statement - completed and current
- **Assets**:
  - All patent applications and assignments (USPTO Provisional #63/913,134)
  - All copyright registrations
  - All software platforms and repositories
  - All revenue, licensing fees, and royalties
  - All contracts and agreements
  - UCC-1 Secured Interest in HJS SERVICES LLC ($350,000)
  - **Universal Math Engine IP Portfolio** (deployed January 24-25, 2026):
    - Complete mathematical framework (1×1=2, 0×1=1, A+B+× junction value)
  ...
  - **R.O.M.A.N. 2.0 Wearable Body Shield IP Portfolio** (created January 26, 2026):
    ...
    - Harmonic interdiction system design
    - Shear-thickening fluid (STF) formulation
    - Carbon nanotube (CNT) architecture
    ...
    - Component procurement specifications (325+ items, $6,500-$13,691 budgets)
...
- **Commercial Lease**: Studio 37, 159 Oneta Street, Athens, GA
  ...
  - Buy-Out Option: 3 months' rent plus security deposit forfeiture
- **Legal Position**: Subject to UCC-1 Financing Statement (Secured Party: ODYSSEY-1 AI LLC)
  - Filing Record: 029-2026-000007 (Clarke County, filed January 7, 2026)
...
**Beneficiary Designation**: All life insurance policies shall name Howard Jones Bloodline Ancestral Trust as primary beneficiary. Grantors shall execute beneficiary change forms with each insurance company to effectuate this designation.
...
- **Power System**: Energetic System Modeling with Third Eye Transceiver
- **Chi Network**: Replaces traditional wiring for energy distribution
- **Schumann Resonance**: Optimized for receiving and stabilizing 7.83 Hz ambient frequency

#### 2. Quantum AI Reality Engine (QARE)
- **Foundational Model**: Reality-shaping AI built on Quantum Programmed AI (QPAI) concept
- **Master Knowledge Base**: Mathematics, Physics, Physiology, Molecular Dynamics
- **Integrated Ethical Framework**: Constitutional governance and Divine Intent alignment

#### 3. Intellectual Property Registry
- **Database**: Comprehensive IP tracking system (patents, copyrights, trademarks, trade secrets)
...
- Comparable 1: Copy.ai (basic AI writing) = $500M valuation (2023)
- Comparable 2: Jasper AI (marketing content) = $1.5B valuation (2022)
- Comparable 3: Character.AI (conversational AI, minimal revenue) = $1B valuation (2023)
- Comparable 4: Inflection AI (personal AI assistant, ZERO revenue) = $4B valuation (2023)
- R.O.M.A.N. Conservative: $200M = 40% of Copy.ai despite superior capabilities
- R.O.M.A.N. Differentiators: Constitutional governance, patent protection (#63/913,134), legal defense capabilities, multi-AI coordination, 17+ industry themes, self-awareness, operational TODAY with 17,000+ lines of production code

**PAGE 13 of 21**

**Patent Portfolio (25 Total - $125M-750M):**

**Filed USPTO Patents (5):**
1. #63/913,134 (Provisional): Dual-Hemisphere AI ($50M-500M comparable to OpenAI GPT architecture)
2. #19/396,082 (Nonprovisional): Cordless Cube Neural Authentication ($10M-300M comparable to Apple biometrics)
3. #63/922,762 (Provisional): ODYSSEY VISION AR/Optometry ($5M-200M comparable to Google Glass/Meta AR)
4. #19/403,956 (Nonprovisional): Harmonic Resonance Grid ($10M-500M comparable to Tesla wireless power)
5. PPA Filed 12/04/2025: Shoe Sole Piezoelectric Emitter ($5M-50M comparable to Nike self-lacing)

**Pending PPA Filing (6):**
6. Sovereign Vessel System - Autonomic Hardware Platform ($5M-100M)
7. Virtual Reality Goggles - Entertainment/Training System ($3M-75M)
8. EradiSkin™ - Pharmaceutical Co-Therapy ($10M-500M, FDA approval milestone $500K-1M)
9. Ezekiel's Wheel - Autonomous VTOL ISR ($10M-1B, defense applications)
10. Project Sky Sovereign - Quantum Airspace Management ($5M-500M)
11. Additional AI Continuations ($2M-100M)

**Integrated R.O.M.A.N. 2.0 Innovations (14 Core Patents - Not Filed Separately):**
12. Dual Hemisphere AI Architecture (Constitutional Validation Layer)
13. HiveOrchestrator Digital Homeostasis (Self-Healing AI)
14. Constitutional Validation Layer (9 Immutable Principles)
15. Double Helix Design Pattern (DNA-Inspired Software)
16. GenesisEngine Biological AI (DNA/RNA/Immune System Model)
17. QARE - Quantum AI Reality Engine (Dream Theory Coding)
18. Roman Governance AI Protocol
19. Dream Theory Coding Paradigm
20. R.O.M.A.N. CPU Architecture
21. NPU Intent Translation Engine
22. Lumen Engine (GPU/Projector Integration)
23. Lumen-Link Protocol
24. Shape-Shifting Theme System (17+ Industry Templates)
25. Sovereign Frequency Authentication System

**7-Book Copyrighted Series ($10M-75M):**
- Registration Case #1-15033889051 (Filed 11/06/2025)
- Total 105,000 words across 7 volumes
- Conservative: $10M (baseline IP value as constitutional framework)
- Market-Based: $25M (mainstream adoption, course licensing, corporate training)
- Optimistic: $75M (bestseller status, film adaptation, Fortune 500 DEI licensing)

**Odyssey-1 Platform ($10M-150M):**
- 17,000+ lines of production code
- 114 database tables (complete enterprise backend)
- 17+ industry theme templates (operational shapeshifting)
- SaaS valuation: 10-50x projected ARR with AI differentiation
- Comparable: ServiceTitan (home services platform) valued at $9.5B with $600M ARR

**Harmonic Grid IP ($15M-1B):**
- 5 energy patents filed/pending (HRG System, Shoe Sole, Ezekiel's Wheel components)
- Conservative: $15M pre-prototype validation
- Market-Based: $100M post-$160 prototype validation
- Optimistic: $1B if commercially deployed (wireless power grid replacing electrical infrastructure)

**Trade Secrets & Constitutional Framework ($5M-50M):**
- 17,000+ lines proprietary source code architecture (not publicly disclosed)
- 51-dimensional Grassmannian manifold Constitutional Hash algorithm
- Sovereign Frequency authentication methodology
- 9 Foundational Principles + 4 Immutable Laws
- GenesisEngine biological AI model implementation

**Domains, Trademarks, Music, Branding ($1M-10M):**
- odyssey-1-ai.com (primary domain)
- 7 trademarks ready to file (ODYSSEY-1, R.O.M.A.N., THE HIVE, EradiSkin™, Ezekiel's Wheel, Project Sky Sovereign, QARE)
- 52-song copyrighted music collection (DistroKid distribution)
...
- All revenue from licensing, royalties, milestone payments, and commercialization
- Any future business entities formed for IP commercialization
...
**Ultimate Disposition (If Entire Bloodline Extinct):**
- If at any time no descendants of the Howard or Jones bloodline are living, and no Alternate Beneficiaries survive, trust shall continue as perpetual charitable trust managed by the institutions below (NOT by Clarke County courts)
- Trust assets shall be distributed as follows:
  - 25% to Morehouse College (Atlanta, GA) - Endowed scholarship fund for Black men pursuing STEM, technology, AI, computer science, engineering, and patent law. This fund explicitly supports Black men who have been historically underserved and excluded from educational opportunities, INCLUDING formerly incarcerated individuals seeking education and rehabilitation through higher learning. No applicant shall be disqualified based on criminal history.
  - 20% to Spelman College (Atlanta, GA) - Endowed scholarship fund for Black women in technology, engineering, entrepreneurship, and innovation. Equal support for our sisters in STEM fields, INCLUDING formerly incarcerated Black women rebuilding their lives through education. Second chances and redemption through learning are core values of this fund.
  - 15% to Clark Atlanta University (Atlanta, GA) - Innovation fund supporting Black men and Black women inventors, patent applications, and technology startups founded by CAU students and alumni. This fund serves both brothers and sisters equally in the innovation economy, with EXPLICIT PRIORITY for formerly incarcerated entrepreneurs who have paid their debt to society and deserve opportunity to start businesses, file patents, and build legitimate wealth. Funding available for business plans, startup capital, patent filing fees, and mentorship programs for returning citizens.
  - 10% to K-12 Education Programs - Supporting STEM education for Black and underserved youth in Georgia public schools. Funding directed to 100 Black Men of America (Atlanta chapter), KIPP Metro Atlanta Schools, and National Alliance of Black School Educators for mentorship programs, after-school STEM labs, computer science curriculum, and college prep programs. This reaches children BEFORE college, planting seeds of innovation in elementary and middle school. Priority for schools serving low-income communities where children lack access to technology education.
  - 10% to Homeless Services - Supporting comprehensive programs for homeless individuals and families, including emergency food distribution, transitional housing, job re-education and skills training, mental health counseling, and addiction recovery services. Funding directed to Atlanta Mission, MUST Ministries (Georgia), and Covenant House Georgia. Services must be provided with dignity and respect, without judgment, recognizing that homelessness can happen to anyone. Programs must address root causes (mental health, job training, housing) not just symptoms.
  - 10% to National Council on Aging (or Georgia Council on Aging) - Programs supporting elderly and senior citizens, with preference for services benefiting Black seniors and underserved communities in Georgia
  - 10% to National Association of Black Inventors (if still operating) - Supporting Black men and Black women patent holders and innovators nationwide, including formerly incarcerated inventors who have been excluded from traditional funding sources
- Each institution shall maintain separate endowment managed by their foundation
- Annual distributions from endowment income only (preserve principal perpetually)
- NO involvement from Clarke County courts, University of Georgia, Athens-Clarke County government, or any institution that has historically oppressed poor communities
- Trustees shall ensure all recipient organizations serve the poor and underserved WITHOUT discrimination, WITHOUT foot-on-neck tactics, and WITH genuine commitment to uplift
- If any named institution no longer exists or begins to oppress rather than serve, such institution's share shall be redistributed pro rata among surviving institutions that maintain their mission
...
**Tax Apportionment:**
- All estate taxes, inheritance taxes, and death taxes attributable to trust assets shall be paid from trust principal before distribution
- Taxes shall be apportioned among beneficiaries in proportion to their beneficial interests
- Trustees may rely on qualified estate tax attorney for apportionment calculation
- No beneficiary shall receive distribution until all applicable taxes are paid or adequately reserved

**Georgia Trust Code Applicability:**
- This Trust is governed by Georgia Trust Code (O.C.G.A. Title 53)
- To the extent any provision conflicts with mandatory provisions of Georgia Trust Code, the Trust Code shall control
- All rights, powers, and duties of Trustees are subject to Georgia Trust Code fiduciary standards
- Beneficiaries have all rights granted under O.C.G.A. § 53-12-370 (right to information, accounting, etc.)
...
- Grantor shall maintain confidential letter of instruction with passwords and access credentials
...
- Notwithstanding any other provision, this Trust shall terminate no later than 21 years after the death of the last survivor of the following individuals living on the date of this Trust: Rickey Allan Howard, Christla Howard, Teara Howard, Kenneth Howard, Keith Sorrells, Ahmad Rashad Barnett, and Derrick Williams
- Upon termination, all trust assets shall be distributed to the then-living beneficiaries per stirpes
- This clause ensures compliance with Georgia's Rule Against Perpetuities

**Anti-Lapse Provision:**
- If any beneficiary predeceases both Grantors, such beneficiary's share shall pass to that beneficiary's descendants per stirpes
- If a beneficiary dies without descendants, such beneficiary's share shall be redistributed pro rata among surviving beneficiaries
- No lapsed gifts shall revert to Grantors' estates or pass by intestacy
...
- Spendthrift clause: Beneficiaries cannot pledge, assign, or encumber their interest
- HEMS Standard: Distributions limited to Health, Education, Maintenance, and Support
- UCC-1 Priority: ODYSSEY-1 AI LLC maintains senior secured position over HJS SERVICES LLC assets
...
- To the maximum extent permitted by Georgia law, no beneficiary's interest in trust income or principal shall be subject to the claims of creditors, assignees, or transferees
- Beneficiaries cannot voluntarily or involuntarily alienate, encumber, or anticipate their interest
- This protection applies to all successor beneficiaries (children, grandchildren, descendants) with full force
- Exception: Support obligations, federal tax liens, and fraudulent conveyance claims may pierce spendthrift protection

**Lawsuit Protection:**
- Intellectual property held by Trust, not personally by Grantors
- Business operations separated from IP ownership through dual-entity structure
- Liability limited to operating companies (ODYSSEY-1 AI LLC, HJS SERVICES LLC)
- Trust assets shielded from business litigation and unsecured creditor claims
- Commercial insurance coverage: $1,000,000 General Aggregate (CGL Policy)

**Corporate Governance:**
- Operating agreements and bylaws establish limited liability protection
- Proper corporate formalities maintained for both LLCs
- Annual meetings documented in official corporate minutes
...
### 7A.1 Discretionary Distribution Authority
...
### 7A.2 Automatic Transfer on Seizure Attempt (Poison Pill)
...
4. **Preservation of Intent**: The Grantors' original intent (protection of family assets) shall govern the Successor Trust
...
### 7A.3 Charging Order as Exclusive Remedy
...
### 7A.4 Intellectual Property Segregation

All intellectual property held by this Trust (including the Odyssey-1-App, R.O.M.A.N. Protocol, Universal Math algorithms, all patents, copyrights, and trademarks) is **Trust property**, not personal property of the Grantors or any Beneficiary.

**Corporate Liability Shield**: The intellectual property shall NOT be liable for:

1. Personal debts of the Grantors or Beneficiaries
2. Business liabilities of any company operated by the Grantors or Beneficiaries
3. Tax claims against the Grantors or Beneficiaries in their individual capacity
4. Judgments arising from the Grantors' or Beneficiaries' personal conduct
...
**Licensing Authority**: Only the Trustee(s) have authority to license, sell, or transfer the intellectual property. The Grantors and Beneficiaries have no individual power to encumber the IP.

**Third-Party Notice**: Any party contracting with the Grantors or Beneficiaries acknowledges that the intellectual property is Trust property and is not available to satisfy personal obligations of the Grantors or Beneficiaries.

### 7A.5 Tax Compliance and Lawful Exemption Preservation

The Grantors and Trustees declare the following tax characterization:

**Private Trust Status**: This Trust is a **private, irrevocable trust** established under the Georgia Trust Code (O.C.G.A. Title 53) and Common Law. It is NOT:
- A statutory business trust
- A corporation
- A partnership

**Tax Compliance**: This Trust shall comply with all applicable federal and state tax laws, including the filing of IRS Form 1041 (U.S. Income Tax Return for Estates and Trusts) as required. The Trustees shall engage qualified tax counsel to ensure proper and timely filings consistent with the Trust's legal obligations.

**Lawful Exemption Assertion**: The Trustees shall actively identify and assert all lawful tax exemptions, deductions, and credits available to this Trust under applicable law, including:
- All basis offsets available under IRC § 1012 against revenue derived from intellectual property
- All deductions available to irrevocable trusts under IRC § 651 and § 661
- All exemptions available to religious organizations under IRC § 508(c)(1)(a) to the extent the Trust qualifies by reason of the Grantors' ministerial standing under recognized ecclesiastical authority
- All state tax exemptions available under Georgia law

**Reservation of Rights**: The Trustees reserve all lawful constitutional and statutory defenses against any tax assessment that exceeds what is legally required. All tax reporting is made in good faith compliance with applicable law while preserving all rights to contest assessments through proper legal channels, including U.S. Tax Court, without waiving any defense available at law or equity.

**Ministerial Standing**: The Grantors, Rickey Allan Howard and Joseph Lumpkin Jr., hold recognized ministerial credentials. To the extent such standing qualifies Trust activities for religious organization treatment under applicable federal and Georgia law, the Trustees shall pursue such recognition through proper legal channels.

### 7A.6 Ecclesiastical Governance and Jurisdictional Preference

**Ecclesiastical Foundation**: This Trust is established in part upon the ministerial authority and ecclesiastical standing of the Grantors, Rickey Allan Howard and Joseph Lumpkin Jr., both of whom hold recognized ministerial credentials. The Trust's governance is informed by the ecclesiastical principles and Natural Law values held by the Grantors, consistent with the religious liberty protections afforded under Georgia law (O.C.G.A. § 9-8-1 et seq.) and the First Amendment to the United States Constitution.

**Georgia Law Governs**: This Trust is governed by and construed in accordance with the laws of the State of Georgia, including the Georgia Trust Code (O.C.G.A. Title 53). Nothing in this Article shall be construed to place the Trust outside the jurisdiction of courts of competent jurisdiction where such jurisdiction is required by law.

**Jurisdictional Preference**: To the fullest extent permitted by law, the Trustees prefer resolution of Trust matters through the following hierarchy:

1. **Primary Forum**: Internal ecclesiastical governance by the Co-Trustees in accordance with the Trust's stated values and Natural Law principles
2. **Secondary Forum**: Mediation and arbitration as specified in Article IX
3. **Tertiary Forum**: State court of competent jurisdiction in Clarke County, Georgia
4. **Federal Forum**: Federal court jurisdiction is not preferred and shall only be invoked where state court jurisdiction is unavailable or legally required
...
**Severability Clause:**
- If any provision of this Trust is held invalid, illegal, or unenforceable by a court of competent jurisdiction, the remaining provisions shall continue in full force and effect
- Invalid provisions shall be reformed to the minimum extent necessary to make them valid and enforceable while preserving the Grantors' intent
- If any provision cannot be reformed, it shall be severed and the Trust shall operate as if such provision had never been included

**Reformation Authority:**
- If any trust provision conflicts with Georgia law, federal tax law, or USPTO regulations, trustees are authorized to reform such provision to comply with applicable law while preserving maximum tax benefits and asset protection
- Trustees may petition court for reformation if needed to: (1) comply with tax law changes, (2) correct scrivener's errors, (3) clarify ambiguous provisions, (4) update references to superseded statutes

**Savings Clause:**
- This Trust is intended to comply with all applicable Georgia trust law, federal tax law, and USPTO intellectual property regulations
- If any provision would cause adverse tax consequences or loss of asset protection, such provision shall be interpreted to avoid such consequences
- Trustee actions shall be construed liberally to effectuate Grantors' intent: maximum asset protection, tax efficiency, and IP commercialization flexibility
...
I declare that I am a competent witness to the execution of this Trust Agreement, that I personally know the Grantors, that I witnessed the execution of this document, and that the Grantors declared to me their intent to be bound by this Trust Agreement.
...
**A. ODYSSEY-1 AI LLC**:
   ...
   - **Intellectual Property Portfolio** (R.O.M.A.N. 2.0 Wearable Body Shield):
     ...
     * 4 pending patent applications (harmonic interdiction, STF weave, piezo harvesting, sensor fusion)
     * Proprietary trade secrets (STF formulation, harmonic algorithms, energy management circuits)
     * Component procurement specifications and manufacturing blueprints
     * Market analysis and business model ($290M projected 5-year revenue)
     * **Conservative Pre-Prototype Valuation: $750,000** (based on documented development costs, patent-pending status, and comparable early-stage defensive technology IP transactions)

**B. HJS SERVICES LLC**:
   - Business License BT-089217 (Active)
   - Operating Agreement dated January 1, 2009
   - Federal Contractor Registration (SAM.gov YXEYCV2T1DM5)
...
**C. Commercial Insurance Policies**:
   ...
   - Auto Policy #50008175201 (6 vehicles insured)

### 3. REAL PROPERTY

**Clarke County Real Estate**:
   - LOT 25, CAMELOT SUBDIVISION
   - Parcel ID: 062D3 E025
   - Legal Description: All that tract or parcel of land lying and being in the 6th District, Clarke County, Georgia, Plat Book 22, Page 219
   - Quitclaim Deed: Book 5782, Page 262 (January 7, 2026)
   - Prior Title: Tax Deed (Book 4820, Page 269), Affidavit (Book 4988, Page 494)

### 4. VEHICLES

**2025 Jeep** (Only vehicle owned):
   - VIN: [To be added]
   - Current lien holder: [To be added - not paid off]
   - Title to be transferred to Trust upon payoff OR held subject to lien

### 5. LIFE INSURANCE POLICIES (ALL Beneficiaries Changed to Trust)

**A. United of Omaha Life Insurance**:
   - Policy Number: UR4748088
   - Insured: Rickey A Howard
   - Face Amount: $15,000
   - Issue Date: December 20, 2019
   - **Beneficiary**: Howard Jones Bloodline Ancestral Trust (to be updated)

**B. Brighthouse Financial Whole Life**:
   - Policy Number: GIW1390708
   - Insured: Rickey A Howard
   - Face Amount: $10,000
   - Cash Value: $1,280 (as of October 21, 2022)
   - **Beneficiary**: Howard Jones Bloodline Ancestral Trust (to be updated)

**C. Mutual of Omaha Accidental Death**:
   - Coverage ID: 394106-38M
   - Insured: Rickey A Howard
   - Coverage Date: December 20, 2019
   - **Beneficiary**: Howard Jones Bloodline Ancestral Trust (to be updated)

**D. Colonial Penn Life Insurance**:
   - Insured: Rickey A Howard
   - Face Amount: $10,000
   - **Beneficiary**: Howard Jones Bloodline Ancestral Trust (to be updated)

**E. Globe Life Term Insurance**:
   - Policy Number: 006R00646
   - Insured: Mickey Howard (DOB: 09/26/1965)
   - Owner: Rickey A Howard
   - Face Amount: $30,000
   - Policy Date: August 12, 2014
   - **Beneficiary**: Howard Jones Bloodline Ancestral Trust (to be updated)

**Total Death Benefit**: $75,000 (all policies combined)

### 6. FINANCIAL ACCOUNTS AND INVESTMENTS

**A. Cryptocurrency Holdings**:

**Uphold Portfolio**:
   - Account ID: 482e3875-7678-4612-bd86-3d54470ee796
   - Holdings: XRP, DOGE, USDC
   - **Owner**: To be retitled to Howard Jones Bloodline Ancestral Trust
...
**Ledger Nano X Cold Storage Wallet**:
   ...
   - ADA (Cardano): 24.4937
   - BTC (Bitcoin): 0.00009152
   - **Owner**: Howard Jones Bloodline Ancestral Trust (Trust controls wallet keys)

**B. Precious Metals**:

**US Gold Bureau Portfolio**:
   - Vault Storage (Home & Secure): ~$1,149.02
   - **Owner**: To be retitled to Howard Jones Bloodline Ancestral Trust
...
**Acorns Investment Account** (Total: $779.46):
   - Invest Account: $499.29 (2.70% return)
   - Later Account: $280.17 (5.14% return)
   - **Beneficiary**: To be updated to Howard Jones Bloodline Ancestral Trust

**Fundrise Real Estate Investment**:
   - Portfolio Value: ~$1,918.94
   - **Beneficiary**: To be updated to Howard Jones Bloodline Ancestral Trust

### 7. PERSONAL PROPERTY

**A. Storage Units (2 Locations)**:
   - Business equipment, tools, supplies, inventory
   - Estimated Value: $35,000+
   - Contents: All items stored become Trust property

**B. Christla Howard's Jewelry Collection**:
   - Wedding Ring
   - Engagement Ring
   - Gold Cross
   - Additional personal jewelry pieces
   - Estimated Value: $20,000
   - **Owner**: Christla Howard transfers to Trust via this Schedule A

**C. Household Furnishings and Personal Effects**:
   - All furniture, appliances, electronics, and household items
   - All personal belongings of Rickey and Christla Howard
   - All tools, equipment, and business assets not otherwise listed

### 8. COPYRIGHTED MUSIC

**52-Song Music Collection**:
   - Distributed via DistroKid
   - All royalties and streaming revenue
   - All copyrights and performance rights
...
**A. Domain Names**:
   ...
   - **Owner**: To be retitled to Howard Jones Bloodline Ancestral Trust via WHOIS update

**B. Digital Infrastructure**:
   - GitHub repositories (Rhoward1967/Odyssey-1-App)
   - All cloud hosting accounts, databases, and services
   - All API keys, credentials, and access controls

### 10. FUTURE PROPERTY AND REVENUE

**A. All After-Acquired Property**:
   - Any intellectual property created or acquired after this date
   - Any business opportunities, contracts, or revenue streams
   - Any appreciation, dividends, or distributions from Trust assets

**B. Revenue Streams**:
   - All licensing fees, royalties, and milestone payments from IP commercialization
   - All business income from ODYSSEY-1 AI LLC and HJS SERVICES LLC
   - All investment returns, interest, and capital gains
   - All proceeds from foreclosure on HJS SERVICES LLC (client list seizure)

### 11. ASSIGNMENT DOCUMENTS

**Executed Concurrently**:
   - Assignment of Business Entity and Intellectual Property to Howard Jones Bloodline Ancestral Trust (dated January 26-27, 2026)
   - UCC-1 Financing Statement (Trust as Secured Party, Odyssey-1 AI LLC as Debtor)
...
Rickey Allan Howard and Christla Howard hereby declare that the above property constitutes ALL assets they currently own, individually and jointly, and they transfer 100% ownership of ALL such property to the Howard Jones Bloodline Ancestral Trust, reserving NO personal ownership in any asset listed above.

The Grantors acknowledge they are transferring these assets BEFORE generating revenue, while having no significant cash or liquid assets, for the legitimate purpose of protecting family wealth for future generations and shielding assets from potential creditor claims.

**Grantor Signatures** (to be executed at notary):

Rickey Allan Howard: _________________________________  
Date: _______________

Christla Howard: _________________________________  
Date: _______________
